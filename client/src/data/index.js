...
export const login = (payload) => asyncHandler(() => axiosInstance.post('/auth/login', payload), 'Login failed');
export const logout = () => asyncHandler(() => axiosInstance.post('/auth/logout'), 'Logout failed');
export const googleLoginUrl = () => `${import.meta.env.VITE_API_BASE_URL || '/api'}/auth/google`;
...
// ===== Password flows (non-CRUD) =====
export const changePassword = (payload) =>
  asyncHandler(() => axiosInstance.post('/auth/change-password', payload),
    'Failed to change password');

export const requestPasswordReset = (payload) =>
  asyncHandler(() => axiosInstance.post('/auth/reset/request', payload),
    'Failed to request password reset');

export const confirmPasswordReset = (payload) =>
  asyncHandler(() => axiosInstance.post('/auth/reset/confirm', payload),
